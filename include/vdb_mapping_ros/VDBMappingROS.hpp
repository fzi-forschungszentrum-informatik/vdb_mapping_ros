  ...
  const geometry_msgs::TransformStamped transform)
{
  ...
  typename VDBMappingT::UpdateGrid::Ptr update;
...
template <typename VDBMappingT>
void VDBMappingROS<VDBMappingT>::publishUpdate(
  const typename VDBMappingT::UpdateGrid::Ptr update) const
{
...
void VDBMappingROS<VDBMappingT>::mapUpdateCallback(const std_msgs::String::ConstPtr& update_msg)
{
  ...
  typename VDBMappingT::UpdateGrid::Ptr update_grid =
    openvdb::gridPtrCast<typename VDBMappingT::UpdateGrid>(grids->front());
